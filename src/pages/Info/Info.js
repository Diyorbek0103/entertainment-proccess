...
export const Info = () => {
  ...
  const { singleCinema, singleCinemaVideo, singleCinemaCredits } = useSelector(
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="img-box">
                  <img
                    className="Content-info-portrait"
                    src={
                  ...
                  />
                  <img
                    className="Content-info-landscape"
                    src={
                ...
                <div className="Content-info-about">
                  <div>
                    <div className="Content-info-title">
                      ...
                      {(
                        singleCinema.first_air_date ||
                        singleCinema.release_date ||
                        "......"
                      ).substring(0, 4)}
                      )
                    </div>
